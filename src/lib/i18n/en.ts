...
export const en = {
  ...
  "visit.noCheckIn": "Calls are recorded by the reps themselves. This screen is for watching the department's, not starting one of your own.",
  ...
  "visit.addNewShop": "Not on the list? Add it",
  "visit.newShopName": "Shop name",
  "visit.addingShop": "Adding…",
  "visit.addShop": "Add and choose",
  "visit.noPin": "No pin",
