...
/**
 * The same account, a different door.
 *
 * This is not a second identity system — it is the same sign-in the main app
 * uses, on its own URL. A field rep's existing login just works here; there
 * is nothing new to give anybody, and nothing new to lose track of.
 */
